...
import { PageOption } from './HomePage';
...
const DeckPicker: React.FC<DeckPickerProps> = ({deckIdOptions, deckChoice, setDeckChoice, handleGoButton}) => {
    ...
    return (
        ...
        <div className="p-6 bg-white rounded shadow-md max-w-md w-full">
            ...
            <button 
                className="w-full p-2 mb-4 text-white bg-blue-500 rounded shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 hover:bg-blue-600"
